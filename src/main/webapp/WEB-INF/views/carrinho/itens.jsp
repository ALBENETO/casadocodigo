		...
		<section class="container middle">
			...
			<table id="cart-table">
					...
					<c:forEach items="${carrinhoCompras.itens }" var="item">
						<tr>
							...
							<td class="remove-item">
							    <form:form 
										servletRelativeAction="${contextPath }carrinho/remover"
										method="post" cssClass="container">
							    	<input type="hidden" value="${item.produto.id }"
											name="produtoId">
							    	<input type="hidden" value="${item.tipoPreco }"
											name="tipoPreco">
				...
				<tfoot>
				    <tr>
				    	<td colspan="4">
						<form:form id="finalizar"
									servletRelativeAction="${contextPath }pagamento/finalizar"
									method="post">
			...
			<h2>
				<a href="/casadocodigo/index">Veja todos os livros que publicamos!</a>
			</h2>
		</section>
	</jsp:body>
</tags:pageTemplate>